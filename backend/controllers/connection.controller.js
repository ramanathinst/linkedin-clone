...
export const sendConnectionRequest = async (req, res) => {
	try {
		...
		// console.log("sender id : ", senderId); // 67422674ce3854856ca75968  - Ramanath 
		// console.log("user id : ", userId);    //  67422691ce3854856ca7597c  - Kamana

		if (senderId.toString() === userId) {
			return res.status(400).json({ message: "You can't send a request to yourself" });
		}

		// 67422674ce3854856ca75968  - Ramanath 
		// 67422691ce3854856ca7597c  - Kamana
		// 674226bcce3854856ca75994  - jothika
		// 67422fe5c04a6a4e084daf6b  - joy


		// connection request id : 674227b6e8a2702bae34b4da

		// 67422adf92f6112d8308338b -request id
...
export const acceptConnectionRequest = async (req, res) => {
	try {
		...
		// console.log("Request ID: ", requestId);  // 67422adf92f6112d8308338b -request id from connection request database
		// console.log("User ID: ", userId);        // 674226bcce3854856ca75994  - jothika

		const request = await ConnectionRequest.findById(requestId)
			.populate("sender", "name email username")
			.populate("recipient", "name username");

			//6742331dc9841bbaa9070c0e  - request id from connection request database
		...
		console.log("request recipient id : ", request.recipient._id);
